        ...
        <?php foreach ($task->offers as $offer): ?>
            <div class="response-card">
                ...
                <div class="feedback-wrapper">
                    <a href="/user/view/<?= $offer->performer_id; ?>" class="link link--block link--big"><?= $offer->performer->name ?></a>
                ...
                <div class="feedback-wrapper">
                    <p class="info-text"><?= Yii::$app->formatter->asRelativeTime($offer->date_add)?></p>
